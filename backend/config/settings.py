...
# Plagiarism detection (runs after viva completes; uses hashes + embeddings)
PLAGIARISM_CHUNK_SIMILARITY_THRESHOLD = float(os.getenv("PLAGIARISM_CHUNK_SIMILARITY_THRESHOLD", "0.88"))
PLAGIARISM_DETECTED_THRESHOLD = float(os.getenv("PLAGIARISM_DETECTED_THRESHOLD", "0.25"))
PLAGIARISM_HIGH_SIMILARITY_THRESHOLD = float(os.getenv("PLAGIARISM_HIGH_SIMILARITY_THRESHOLD", "0.45"))
PLAGIARISM_EMBEDDING_MIN_SCORE = float(os.getenv("PLAGIARISM_EMBEDDING_MIN_SCORE", "0.15"))
PLAGIARISM_MIN_EXACT_MATCHES = int(os.getenv("PLAGIARISM_MIN_EXACT_MATCHES", "3"))
PLAGIARISM_MAX_CHUNKS_COMPARE = int(os.getenv("PLAGIARISM_MAX_CHUNKS_COMPARE", "80"))
PLAGIARISM_MAX_SAMPLE_MATCHES = int(os.getenv("PLAGIARISM_MAX_SAMPLE_MATCHES", "5"))
